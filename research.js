...
createChart=function(canvas,config){
 ...
 for(const [name,axis] of Object.entries(config.options.scales||{})){const k=name==='y'?'co2':name;if(keys.includes(k)&&value('axisStep-'+k)==='')axis.ticks.precision=k==='co2'?0:1}
